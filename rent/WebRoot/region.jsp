             ...
             --> 
              ...
              <table class="layui-table">
                  ...
                  <tbody>
                      ...
                      <s:set value="rlist" var="rt"></s:set>
                      <s:iterator value="rt">
                          <tr>
                         
	                      <td><s:property value="regionid"/></td>
	                      <td><s:property value="regionname"/></td>
	                      <td class="text-center">
                         <div class="layui-btn-group">
                          <button class="layui-btn layui-btn-xs layui-btn-normal dw-dailog" onclick="update1('region_queryByRegionId?rt.regionid=<s:property value='regionid'/>')">
                          ...
                          <button class="layui-btn layui-btn-xs layui-btn-danger dw-delete" onclick="delete1('region_deleteRegion?rt.regionid=<s:property value="regionid"/>')" >
...
layui.use(['layer', 'form'], function(){
	...
	function delete1(url){
		...
		layer.confirm('确认删除吗？',{icon: 7, area: ['200px', '150px'],offset: ['320px', '550px']},function(index){
			 layer.close(index);
			 $.getJSON(url,function(deleteRegionResult){
				    console.log('进入');
					if(deleteRegionResult=='0'){
	...
	function add(){
		layer.open({
		    ...
		    maxmin: true, //开启最大化最小化按钮
		    area: ['600px', '220px'],
			content: ['addRegion.jsp','no'], //iframe的url，no代表不显示滚动条
			end: function(){ //此处用于演示
					location.reload();
			 	 } 
			});
