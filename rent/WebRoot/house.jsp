      ...
      <ul class="layui-nav layui-nav-tree"  lay-filter="test">
        ...
        <li class="layui-nav-item ">
                ...
                <dl class="layui-nav-child">
                    <dd><a class="layui-this" href="region_queryHosue">房源列表</a></dd>
                </dl>
        </li>
        <li class="layui-nav-item ">
             ...
             --> 
              ...
              <table class="layui-table">
                  ...
                  <tbody>
                      ...
                      <s:set value="houselist" var="hl"></s:set>
                      <s:iterator value="hl">
                          <tr>
	                      ...
	                      <td><s:property value="hstatus"/></td>
	                      <td><s:property value="releaseTime"/></td>
	                      <td class="text-center">
                         <div class="layui-btn-group">
                          <button class="layui-btn layui-btn-xs layui-btn-danger dw-delete" onclick="delete1('about_deleteHouse?h.houseid=<s:property value="houseid"/>')" >
