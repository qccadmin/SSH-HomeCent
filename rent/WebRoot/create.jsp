    ...
    <div class="layui-row">
        <div class="layui-col-lg12">
            <fieldset class="layui-elem-field">
                ...
                <legend>户型管理 - 修改户型</legend>
                <div class="layui-field-box">
                    <form class="layui-form" action="housetype_updateHouseType" id="housetype">
                        <div class="layui-form-item">
                            <label class="layui-form-label">户型id</label>
                            <div class="layui-input-block">
                           
                            
                           
                            <input type="text" name="tid" value=" <s:property value="ht.tid"/>" required  lay-verify="required" placeholder="请输入标题" autocomplete="off" class="layui-input" readonly="true">
                            </div>
                        </div>
		                <div class="layui-form-item">
