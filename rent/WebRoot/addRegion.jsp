    ...
    <div class="layui-row">
        <div class="layui-col-lg12">
            <fieldset class="layui-elem-field">
                ...
                <legend>区域管理 - 新增区域</legend>
                <div class="layui-field-box">
                    <form class="layui-form" action="region_addRegion" id="region">

		                <div class="layui-form-item">
		                        <label class="layui-form-label">区域</label>
		                        <div class="layui-input-block">
		                        <input type="text" name="regionname"  required  lay-verify="required"  autocomplete="off" class="layui-input">
		                        </div>
                        </div>
                        <!-- 
                        <div class="layui-form-item">
